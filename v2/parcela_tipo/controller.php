...
class Controlador
{
    ...
    {
        $con = new Conexion();
        $sql = "SELECT id, nombre, activo FROM parcela_tipo;";
    ...
    public function postNuevo($_nuevoObjeto)
    {
        ...
        $sql = "INSERT INTO parcela_tipo (id, nombre, activo) VALUES ($id,'$_nuevoObjeto->TIPO', true)";
    ...
    {
        $con = new Conexion();
        $sql = "UPDATE parcela_tipo SET activo = $_accion WHERE id = 0;";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
    ...
    {
        $con = new Conexion();
        $sql = "UPDATE parcela_tipo SET nombre = 'Nuevo nombre' WHERE id = 0;";
    ...
    {
        $con = new Conexion();
        $sql = "DELETE FROM parcela_tipo WHERE id = 0;";
        //echo $sql;
        //ejecutar sql
        $rs = [];
        try {
